...
if __name__ == "__main__":
    ...
    for update in range(1, num_updates + 1):
        ...
        with torch.no_grad():
            ...
            # calculate GAE
            final_env_id_checked = torch.zeros(args.num_envs, dtype=torch.int32).to(device) - 1
            ...
            lastdones = torch.zeros(args.num_envs).to(device) + 1
            lastvalues = torch.zeros(args.num_envs).to(device) # TODO: we can leverage lastobs to get the lastvalues
